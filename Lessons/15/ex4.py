...
if __name__ == "__main__":
    generuj_pierwsze(4, 14)  # powinno wyświetlić: 5, 7, 11, 13
    generuj_pierwsze(10, 20)  # powinno wyświetlić: 11, 13, 17, 19
    generuj_pierwsze(22, 29)  # powinno wyświetlić: 23, 29
